...
git clone https://github.com/JOHW85/ScrapeFandom
cd ScrapeFandom
python3 -m ppip install -r requirements.txt (which I had to modify)
chmod +x run-me.sh
./run-me.sh forgottenrealms (located in /wikiextractor/ScrapeFandom/)
The last command creates new directories in /ScrapeFandom