...
# Sets up Chrome WebDriver options for headless browsing, which is used for scraping pages that require JavaScript rendering.
...
# Handles the fandom site argument the user passed in
...
while nextpage_url != "":
    listofpages = ""
    try:
        # First try sending a simple request for content
        ...
        if req.content != b'':
            ...
            # If the request fails try using Selenium webdrivers
